/**
 * Create Next's Meteora DBC partner config (one-time per cluster).
 *
...
import { NATIVE_MINT, connectionFor, explorer, loadKeypair, log, nextCurve, sendTx, solUsd } from "./lib.mjs";
